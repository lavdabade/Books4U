    ...
    if (mysqli_num_rows($query_run) > 0) {
      ...
      if($query1_run){
        ...
        if($query2_run)
        {
          ...
          $s_to = $row["Email"];
          $s_subject =  " ". $row2["FN"]. "  " . $row2["LN"]. " has send a request on Books4U.";
          $s_body = "Hi " . $row["FN"]. ",\n
...
Books4U";
          ...
          $b_to = $row2["Email"];
          $b_subject =  "Request has been sent to " . $row["FN"]. "  " . $row["LN"]. " on Books4u";
          $b_body = "Hi " . $row2["FN"]. ",\n
...
Books4U";
          ...
          $header = "From: books4u.project.com";
          $s_mail_query = mail($s_to,$s_subject,$s_body,$header);
          $b_mail_query = mail($b_to,$b_subject,$b_body,$header);
          echo $mail_query;
